\documentclass{IEEEtran}
	\usepackage{csquotes}  % For usage with the IEEEtran document class as to avoid warning
...
\author{
	\IEEEauthorblockN{
		Gordian~Edenhofer\IEEEauthorrefmark{1}\IEEEauthorrefmark{2} and
		Andrew~Collins\IEEEauthorrefmark{1}
	}

	\IEEEauthorblockA{
		\IEEEauthorrefmark{1}Trinity College Dublin, School of Computer Science \& Statistics, ADAPT Centre, Ireland
	}

	\IEEEauthorblockA{
		\IEEEauthorrefmark{2}National Institute of Informatics Tokyo, Digital Content and Media Sciences Division, Japan
	}
...
%\markboth{}{}  % Clear the section and author from page headers
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.45\textwidth,height=\textheight,keepaspectratio]{{{../res/Learning subsystem - Position in Top-N test set}}}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.45\textwidth,height=\textheight,keepaspectratio]{{{../res/Meta-learner Performance - Average position in Top-N test set for various meta-learner algorithms with augmented learning subsystem filtering techniques}}}
