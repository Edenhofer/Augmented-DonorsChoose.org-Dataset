...
\author{
	\IEEEauthorblockN{
		Gordian~Edenhofer\IEEEauthorrefmark{1}\IEEEauthorrefmark{2},
		Joeran~Beel\IEEEauthorrefmark{1}\IEEEauthorrefmark{2}%
		...
		Andrew~Collins\IEEEauthorrefmark{1} and
		Akiko~Aizawa\IEEEauthorrefmark{2}
	}
	...
	\href{mailto:beelj@tcd.ie}{beelj@tcd.ie},
